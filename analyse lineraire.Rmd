...
Accordindg to shapiro test SLA distribution is not normal even if with QQ plot it seems to be normal. Also log transformation does not improve normality assymption whereas it seems to work in some papers like Lajoie & Vellen 2015. 
...
plot(lm(formula = Chloro_content ~ wetness + Competition + aspect + 
    LT_mean + LMDC + SLA, data = data_standar))
