...
Dawkins <- read.csv("C:\\Users\\emduc\\Desktop\\Drive\\symphostage\\Measures - Individuals2.csv", header = T, dec=",", sep=";")
paracou <- read.csv("C:\\Users\\emduc\\Desktop\\Drive\\symphostage\\Symphonia_Paracou.csv",header = T, dec = ",", sep=";")
guyafor <- read.csv("C:\\Users\\emduc\\Desktop\\Drive\\symphostage\\Symphonia_Guyafor.csv",header = T, dec = ",", sep=",")
```
