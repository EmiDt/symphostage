...
select(n_parcelle, n_carre, n_arbre, n_feuille, Area_include, Area_exclude, Dawkins, SPAD.1, SPAD.2, SPAD.3, LT.1, LT.2, LT.3 , Poids.frais, idArbre, Xutm, Yutm, diameter, espece, DryW, wood.diameter, bark.thickness, Idbois, IDEcorce, Bois) %>% 
...
```{r}
Full_traits_data <- Full_traits_data %>% 
  select(n_parcelle, n_carre, n_arbre, n_feuille, morphotype, idArbre, Xutm, Yutm, Area_exclude, Area_include, Dawkins, Fresh_weight, Dry_Weight, diameter, SPAD_mean, LT_mean, Branch_diameter, Bark_thickness, Wood_infra_density, Bark_infra_density, Bois) 
