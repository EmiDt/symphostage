...
library(magrittr)
#<<<<<<< HEAD
path <- "C:\\Users\\emduc\\Desktop\\Drive\\symphostage\\" # path to all data files currently in the same place
setwd(path)
...
#>>>>>>> 23721802fb9fe032b908aca70639454fff4b47eb
```
...
data3 %>% 
  ...
  select(n_parcelle, n_carre, n_arbre, n_feuille,
         SPAD.1, LT.1, Poids.frais, DryW, ecorce)
...
```{r}
Full_traits_data <- Full_traits_data %>% 
  select(n_parcelle, n_carre, n_arbre, n_feuille, morphotype, idArbre, Xutm, Yutm, Area_exclude, Area_include, Dawkins, Fresh_weight, Dry_Weight, diameter, SPAD_mean, LT_mean, Branch_diameter, Bark_thickness, Wood_infra_density, Bark_infra_density, Bois, morphotype_field) 
