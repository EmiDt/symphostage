...
SO  we comine La_data_include_final and LA_include_index_correspondance and then make a test with ifelse to create corrected coloumn

```{r}
LA_data_include_final2 <- LA_data_include_final %>% 
  full_join(LA_include_index_correspondance, by = c("n_parcelle", "n_carre", "n_arbre")) %>% 
