...
Trait_mean_individuals_vect<- Traits_brut_data %>% 
  select(n_parcelle, n_carre, n_arbre, morphotype, Dawkins, diameter, Xutm, Yutm, wood_presence, morphotype_field) %>% 
...
ACP_data2<- environment_trait %>% 
  ...
  select(d_log_gap, d_creek, waterlog, wetness, dem, slope,curvature,aspect, TRI, morphotype_field) 
