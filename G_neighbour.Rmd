...
load(file = "C:\\Users\\emduc\\Desktop\\Drive\\symphostage\\paracou_data\\paracoutree.RData") 

symphonia_stage <- read.csv("C:\\Users\\emduc\\Desktop\\Drive\\symphostage\\Full_traits_data.csv",header = T, dec = ",", sep=";")%>%  group_by(n_parcelle, n_carre, n_arbre) %>% 
  summarize() %>% 
